...
import { listMockPlaybooks } from "../services/mockRepository";

const playbooks = listMockPlaybooks();
    ...
    <div className="space-y-6">
      <section className="rounded-lg bg-ink px-6 py-7 text-white shadow-panel">
        ...
        <p className="mt-3 max-w-3xl text-slate-200">
          Phase 1 shell for discovering CACAO playbooks, opening authoring tools, and routing analysts to
          execution views without rebuilding the existing SOAR stack.
        </p>
      </section>
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-panel">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-600">Mock data for the Phase 1 shell.</p>
            </div>
